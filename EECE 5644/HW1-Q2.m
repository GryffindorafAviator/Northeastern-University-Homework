...
mu(:,1) = [2;5]; mu(:,2) = [3;9];
Sigma(:,:,1) = [1 0;0 1]/3; Sigma(:,:,2) = [2 6;6 20];
p0 = [0.3 0.7]; % probability split between 2 distributions

% Class 1 parameters (2 gaussians)
mu(:,3) = [8;11]; mu(:,4) = [6;1]; 
Sigma(:,:,3) = [5 2;2 3]; Sigma(:,:,4) = [69 -8;-8 16]/13;
p1 = [0.2 0.8]; % probability split between 2 distributions
